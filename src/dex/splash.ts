...
export class Splash extends BaseDex {
     ...
     * On-Chain constants.
     */
    public readonly orderScriptHash: string = 'dbe7a3d8a1d82990992a38eea1a2efaa68e931e252fc92ca1383809b';
    ...
    public async buildSwapOrder(liquidityPool: LiquidityPool, swapParameters: DatumParameters, spendUtxos: SpendUTxO[] = []): Promise<PayToAddress[]> {
        const batcherFee: SwapFee | undefined = this.swapOrderFees().find((fee: SwapFee) => fee.id === 'executionFee');
