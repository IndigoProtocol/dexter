...
import { correspondingReserves, lucidUtils, tokensMatch } from '../utils.js';
import { AddressType, DatumParameterKey } from '../constants.js';
import order from './definitions/minswap-v2/order.js';
export class MinswapV2 extends BaseDex {
    ...
    async buildSwapOrder(liquidityPool, swapParameters, spendUtxos = []) {
        if (!liquidityPool.lpToken)
            return Promise.reject('Unknown LP token');
